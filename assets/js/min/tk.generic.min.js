...
60<$(window).scrollTop()?($(".js-scroll-down").addClass("o-0"),$(".js-subnav").addClass("is-sticky")):($(".js-scroll-down").removeClass("o-0"),$(".js-subnav").removeClass("is-sticky")),l=!1,$(".js-subnav-toggle").removeClass("is-active"),$(".js-subnav, .js-subnav-items").removeClass("is-active")}
...
// subnav
// ------------------------------------------------------------
$(".js-subnav-toggle").click(function(){$(this).toggleClass("is-active"),$(".js-subnav, .js-subnav-items").toggleClass("is-active")});
// scroll magic
// ------------------------------------------------------------
// init controller
